            ...
            <div class="col-lg-7 col-md-8 col-sm-12">
                <ul class="list-unstyled m-0">
                    <li v-for="(item, index) in type" :key="index">
                        ...
                        <a href="javascript:;" v-text="item.name" v-else @click="select_type(item.name,index)" :class="{'active':item.isActive}"></a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 d-flex">
                <input type="text" placeholder="搜索商家，美食" class="align-self-center pl-3" id="search_business" v-model="search_shop"
                    @keyup.13="search">
